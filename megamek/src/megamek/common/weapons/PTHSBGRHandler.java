 ...
 * @since Feb 27, 2024
 */
public class PTHSBGRHandler extends AmmoWeaponHandler {
     ...
     * @param m
     */
    public PTHSBGRHandler(ToHitData t, WeaponAttackAction w, Game g, GameManager m) {
        super(t, w, g, m);
        sSalvoType = " pellet(s) ";
    }
  ...
  protected boolean doChecks(Vector<Report> vPhaseReport) {
    ...
    if ((ae.mpUsed > 0) && (ae instanceof Mech) && ae.canFall()
      ...
      PilotingRollData psr = new PilotingRollData(ae.getId(), nMod,
          "fired Heavy Silver Bullet Gauss unbraced", false);
      game.addPSR(psr);
    }
    return false;
  }
